    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    ...
                    <h3>Constraint List</h3>
        
                    <br>
                    <a href="#add-const-btn" class="btn btn-primary" id="add-const-btn">Add</a>
                    <br>
                    <br>
                    
                    <div id="panel-add-const" class="panel panel-default" style="display: none">

                        <div class="panel-body">
                        <form class="form"  role="form" action="${pageContext.request.contextPath}/Constraint" method="GET">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
              $("#hide").click(function(){
                $("#panel-add-const").hide("fast");
              });
              $("#add-const-btn").click(function(){
                $("#panel-add-const").show("fast");
              });
            });
        </script>
