    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    ...
                    <h3>General Purpose List</h3>
                    
                                      
                    <br>
                    <a href="#add-gen-btn" class="btn btn-primary" id="add-gen-btn">Add</a>
                    <br>
                    <br>
                    <div id="panel-gen-asign" class="panel panel-default" style="display: none">

                        <div class="panel-body">
                            
                        <form class="form"  role="form" action="${pageContext.request.contextPath}/GenPurpose" method="post">
                            ...
                            <div class="form-group">
                                <label for=procDataBus">Processor Data Bus</label>
                                <select name="procDataBus" class="form-control">
                            ...
                            <div class="form-group">
                                <label for="ramAmount">RAM Amount</label>
                                <input type=number step=0.01 min="0" class="form-control" name="ramAmount" id="amount" placeholder="Enter amount">
                            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
              $("#hide").click(function(){
                $("#panel-gen-asign").hide("fast");
              });
              $("#add-gen-btn").click(function(){
                $("#panel-gen-asign").show("fast");
              });
            });
        </script>
