        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    ...
                    <br>
                    <a href="#add-ram-btn" class="btn btn-primary" id="add-ram-btn">Add</a>
                    <br>
                    <br>
                    
                    <div id="panel-add-ram" class="panel panel-default" style="display: none">

                        <div class="panel-body">
                        <form class="form"  role="form" action="${pageContext.request.contextPath}/Ram" method="GET">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" name="frecuency" id="frecuency" placeholder="Enter frecuency">
                            </div>
