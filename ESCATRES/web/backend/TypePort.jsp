    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    ...
                    <h3>Type Port List</h3>
        
                    <br>
                    <a href="#add-typePort-btn" class="btn btn-primary" id="add-typePort-btn">Add</a>
                    <br>
                    <br>
                    
                    <div id="panel-add-typePort" class="panel panel-default" style="display: none">

                        <div class="panel-body">
                        <form class="form"  role="form" action="${pageContext.request.contextPath}/TypePort" method="GET">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
              $("#hide").click(function(){
                $("#panel-add-typePort").hide("fast");
              });
              $("#add-typePort-btn").click(function(){
                $("#panel-add-typePort").show("fast");
              });
            });
        </script>
