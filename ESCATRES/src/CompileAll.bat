...
"%_JAVACCMD%" -encoding UTF-8 -d %_CLASSES% -classpath %_CLASSPATH% %_SOURCEPATH%\esca_orm\*.java %_SOURCEPATH%\esca_orm\impl\*.java %_SOURCEPATH%\esca_orm\dao\*.java %_SOURCEPATH%\ormsamples\*.java 
