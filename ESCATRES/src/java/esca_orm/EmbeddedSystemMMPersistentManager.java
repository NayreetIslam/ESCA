...
public class EmbeddedSystemMMPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "EmbeddedSystemMM";
	...
	private EmbeddedSystemMMPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new EmbeddedSystemMMPersistentManager();
		}
